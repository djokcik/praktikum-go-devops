...
func (c *metricsClient) SendMetric(ctx context.Context, in *SendMetricRequest, opts ...grpc.CallOption) (*SendMetricResponse, error) {
	out := new(SendMetricResponse)
	err := c.cc.Invoke(ctx, "/grpc.Metrics/SendMetric", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (UnimplementedMetricsServer) SendMetric(context.Context, *SendMetricRequest) (*SendMetricResponse, error) {
...
func _Metrics_SendMetric_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/grpc.Metrics/SendMetric",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(MetricsServer).SendMetric(ctx, req.(*SendMetricRequest))
	}
