...
// CounterDatabaseService is an autogenerated mock type for the counterDatabaseService type
type CounterDatabaseService struct {
	mock.Mock
}

// Get provides a mock function with given fields: ctx, name
func (_m *CounterDatabaseService) Get(ctx context.Context, name string) (metric.Counter, error) {
...
func (_m *CounterDatabaseService) List(ctx context.Context) ([]metric.Metric, error) {
	ret := _m.Called(ctx)
...
func (_m *CounterDatabaseService) Update(ctx context.Context, name string, value metric.Counter) error {
