...
func NewMetricFileStorer(ctx context.Context, inMemoryDB *model.InMemoryMetricDB, cfg server.Config) MetricStorer {
...
func (s MetricFileStorer) Ping(ctx context.Context) error {
	return nil
}
