...
func (_m *Repository) Get(ctx context.Context, name string) (metric.Counter, error) {
...
func (_m *Repository) Update(ctx context.Context, name string, value metric.Counter) error {
...
func (_m *Repository) UpdateList(ctx context.Context, metrics []metric.CounterDto) error {
